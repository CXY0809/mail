...
package com.cxy.template.aliyunoss;
...
//            System.out.println("Object：" + firstKey + "的内容是：" + objectContent);
            ...
            //上传本地文件
            String fileKey = "cat.jpg";
            ossClient.putObject(bucketName, fileKey, new File("/Users/cuixiaoyan/biancheng/idea-workspace/springboot-demo/template/src/main/java/com/cxy/template/aliyunoss/file/cat.jpg"));
